...
let wrongAlternatives = ["Sunlight", "Fishlight", "Human flesh", "Wopper"]
// 
for (let index = 0; index < 4; index++) {
    if (index == randomNum) {
        buttons.push("jellyfish")
    }
    else {
...
document.querySelector("p.question").textContent = "What do Ocean Sunfish eat?";
